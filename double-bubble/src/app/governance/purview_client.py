"""Azure Purview client (lightweight).

Supports registering assets and glossary terms. Works with either:
- azure-identity (DefaultAzureCredential), if available, or
- a pre-fetched bearer token in AZURE_ACCESS_TOKEN.

Minimal surface to keep template portable; safe no-op fallbacks.
"""
